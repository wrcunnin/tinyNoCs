...
`CREATE_ENDPOINT_RING_XBAR(0, 32'h00000000, 32'h0FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(1, 32'h10000000, 32'h1FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(2, 32'h20000000, 32'h2FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(3, 32'h30000000, 32'h3FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(4, 32'h40000000, 32'h4FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(5, 32'h50000000, 32'h5FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(6, 32'h60000000, 32'h6FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(7, 32'h70000000, 32'h7FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(8, 32'h80000000, 32'h8FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(9, 32'h90000000, 32'h9FFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(10, 32'hA0000000, 32'hAFFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(11, 32'hB0000000, 32'hBFFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(12, 32'hC0000000, 32'hCFFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(13, 32'hD0000000, 32'hDFFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(14, 32'hE0000000, 32'hEFFFFFFF);
`CREATE_ENDPOINT_RING_XBAR(15, 32'hF0000000, 32'hFFFFFFFF);
