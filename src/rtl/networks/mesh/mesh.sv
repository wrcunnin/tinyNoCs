...
`else
  ...
  // First row
  `CREATE_MESH_XBAR(1, 1, 3, 5, 1);
  `CREATE_MESH_XBAR(2, 1, 3, 5, 0);
  `CREATE_MESH_XBAR(3, 1, 3, 5, 1);
  ...
  // Fifth Row
  `CREATE_MESH_XBAR(1, 5, 3, 5, 1);
  `CREATE_MESH_XBAR(2, 5, 3, 5, 0);
  `CREATE_MESH_XBAR(3, 5, 3, 5, 1);

  // Connecting everything!
  // First Row
  // (1, 1)
  `CONNECT_MESH_XBAR_TO_ENDPOINT(1, 1, endpoint_13_net, north);
  `CONNECT_MESH_XBARS(1, 1, mesh_xbar_1_2, south, north);
  `CONNECT_MESH_XBARS(1, 1, mesh_xbar_2_1, east, west);
  `CONNECT_MESH_XBAR_TO_ENDPOINT(1, 1, endpoint_0_net, west);

  // (2, 1)
  `CONNECT_MESH_XBAR_TO_ENDPOINT(2, 1, endpoint_14_net, north);
  `CONNECT_MESH_XBARS(2, 1, mesh_xbar_2_2, south, north);
  `CONNECT_MESH_XBARS(2, 1, mesh_xbar_3_1, east, west);
  `CONNECT_MESH_XBARS(2, 1, mesh_xbar_1_1, west, east);

  // (3, 1)
  `CONNECT_MESH_XBAR_TO_ENDPOINT(3, 1, endpoint_15_net, north);
  `CONNECT_MESH_XBARS(3, 1, mesh_xbar_3_2, south, north);
  `CONNECT_MESH_XBAR_TO_ENDPOINT(3, 1, endpoint_8_net, east);
  `CONNECT_MESH_XBARS(3, 1, mesh_xbar_2_1, west, east);
  ...
  // (1, 4)
  `CONNECT_MESH_XBARS(1, 4, mesh_xbar_1_3, north, south);
  `CONNECT_MESH_XBARS(1, 4, mesh_xbar_1_5, south, north);
  `CONNECT_MESH_XBARS(1, 4, mesh_xbar_2_4, east, west);
  `CONNECT_MESH_XBAR_TO_ENDPOINT(1, 4, endpoint_3_net, west);

  // (2, 4)
  `CONNECT_MESH_XBARS(2, 4, mesh_xbar_2_3, north, south);
  `CONNECT_MESH_XBARS(2, 4, mesh_xbar_2_5, south, north);
  `CONNECT_MESH_XBARS(2, 4, mesh_xbar_3_4, east, west);
  `CONNECT_MESH_XBARS(2, 4, mesh_xbar_1_4, west, east);

  // (3, 4)
  `CONNECT_MESH_XBARS(3, 4, mesh_xbar_3_3, north, south);
  `CONNECT_MESH_XBARS(3, 4, mesh_xbar_3_5, south, north);
  `CONNECT_MESH_XBAR_TO_ENDPOINT(3, 4, endpoint_11_net, east);
  `CONNECT_MESH_XBARS(3, 4, mesh_xbar_2_4, west, east);

  // Fifth Row
  // (1, 5)
  `CONNECT_MESH_XBARS(1, 5, mesh_xbar_1_4, north, south);
  `CONNECT_MESH_XBAR_TO_ENDPOINT(1, 5, endpoint_5_net, south);
  `CONNECT_MESH_XBARS(1, 5, mesh_xbar_2_5, east, west);
  `CONNECT_MESH_XBAR_TO_ENDPOINT(1, 5, endpoint_4_net, west);

  // (2, 5)
  `CONNECT_MESH_XBARS(2, 5, mesh_xbar_2_4, north, south);
  `CONNECT_MESH_XBAR_TO_ENDPOINT(2, 5, endpoint_6_net, south);
  `CONNECT_MESH_XBARS(2, 5, mesh_xbar_3_5, east, west);
  `CONNECT_MESH_XBARS(2, 5, mesh_xbar_1_5, west, east);

  // (3, 5)
  `CONNECT_MESH_XBARS(3, 5, mesh_xbar_3_4, north, south);
  `CONNECT_MESH_XBAR_TO_ENDPOINT(3, 5, endpoint_7_net, south);
  `CONNECT_MESH_XBAR_TO_ENDPOINT(3, 5, endpoint_12_net, east);
  `CONNECT_MESH_XBARS(3, 5, mesh_xbar_2_5, west, east);
